...
export async function fillFields(dataDict) {
    ...
    let purchasePrice = (parseFloat(dataDict["totalDelivered"]) -
                            parseFloat(dataDict["plateFee"]) - 
                            parseFloat(dataDict["plateTransFee"]) - 
                            parseFloat(dataDict["titleFee"]) - 
                            parseFloat(dataDict["titleLateFee"]) - 
